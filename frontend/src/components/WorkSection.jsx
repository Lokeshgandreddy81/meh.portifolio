  ...
  return (
    <section className="py-0">
      <div className="w-full">
        ...
        <div className="grid grid-cols-2 border-b section-border min-h-screen">
          <div className="px-16 py-24 flex flex-col justify-center border-r section-border">
            {/* Company Logo */}
            <div className="w-24 h-24 rounded-3xl logo-box flex items-center justify-center mb-12 transition-colors duration-300">
            ...
            {/* Description */}
            <div className="text-muted text-lg leading-relaxed space-y-4 mb-12">
          ...
          <div className="px-16 py-24 flex items-center justify-center">
            <LotusFlower className="decorative-svg" />
          </div>
        </div>

        {/* AI Consultant Section - Decoration Left, Text Right */}
        <div className="grid grid-cols-2 border-b section-border min-h-screen">
          <div className="px-16 py-24 flex items-center justify-center border-r section-border">
            <BotanicalLeaf className="decorative-svg" />
          </div>
